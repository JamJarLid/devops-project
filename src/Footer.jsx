export default function Footer() {
	return <>
		<footer>
			...
			<h3>Adoveo</h3>
			<p className="text-justify">Adoveo DevOps team aims to provide you with an overview of the key principles and processes we follow to promote collaboration, speed and continuous delivery of high-quality software products.</p>
			<p className="email"><a href="info@adoveo_devops.com">info@adoveo_devops.com</a></p>
		</div>
